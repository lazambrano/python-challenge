...
election_data = os.path.join(os.getcwd(),'Documents','Dome','repos','python-challenge','PyPoll','Resources','election_data.csv')
...
candidates = []
	...
	#List to capture the number of votes for each candidate
num_votes = []
	

	#List to capture the percentage of total votes each gets 
percent_votes = []
